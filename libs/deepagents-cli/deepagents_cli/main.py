...
from deepagents_cli.tools import fetch_url, http_request, web_search, load_word, load_excel, load_pdf, copy_and_rename_template_file
...
async def _run_agent_session(
    ...
    tools = [http_request, fetch_url, load_word, load_excel, load_pdf, copy_and_rename_template_file]
